...
.contents-why { font-style: italic; font-size: 26px; line-height: 36px; height: 36px; overflow: hidden; color: #444; }
...
.crow-unwritten .ctitle, .crow-unwritten .cnum { color: #555; }
.cleader { flex: 1 1 auto; border-bottom: 2px dotted #777; margin: 0 24px 10px 0; align-self: flex-end; height: 54%%; }
.cstate { flex: 0 0 auto; font-size: 22px; font-weight: 600; letter-spacing: 0.10em; color: #333; }
.cstate-now { color: #000; }
.cstate-unwritten { flex: 0 0 auto; margin-left: auto; font-style: italic; font-size: 26px; color: #555; }`,
		ContentsRowH)
}
